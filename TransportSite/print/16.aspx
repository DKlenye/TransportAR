...
<div id="prn_waybillType" offset="true">/16/</div>
	...
	<div offset="true" id="prn_drivers">
	   <div style="height: 20mm; width: 85mm; overflow: hidden;"><div><span style="width: 68mm;"> <%Response.Write(DriverFio(1)); %> <%Response.Write(DriverLicence(1)); %></span> <%Response.Write(DriverTab(1)); %></div>
	   <div style="height: 20mm; width: 85mm; overflow: hidden;"><div><span style="width: 68mm;"> <%Response.Write(DriverFio(2)); %> <%Response.Write(DriverLicence(2)); %></span> <%Response.Write(DriverTab(2)); %></div>
	   </div>
	   </div>
  </div>
	   <div offset="true" id="prn1_drivers"><div style="height: 12mm; width: 48mm; overflow: hidden;"><div> <%Response.Write(DriverFio(1)); %> </div><div> <%Response.Write(DriverFio(2)); %> </div></div></div>
	   <div offset="true" id="prn_wayStart">НОВОПОЛОЦК</div>
