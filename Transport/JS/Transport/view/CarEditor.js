	         ...
	         items:[	         
	            ...
	            ),
	            {
	               ...
	               items:[
	                  ...
	                  buildPropEditor(['RefuellingGroupId', 'AccGroupId', 'AccGroupNewId', 'BodyTypeId', 'Category', 'ServiceGroupId', 'GroupRequestId', 'ReportGroupId', 'VehicleOilGroupId', 'VehicleModelId','BusinessPlanGroupId'],
