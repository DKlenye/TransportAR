    ...
    */
    ...
    calculate : function(rs, cm) {
        ...
        for (i = 0, len = cfg.length; i < len; i++) {
			...
			data[cname]=parseFloat(data[cname].toFixed(cf.decimalPrecision||3));
        }
        return data;
    },
    ...
    refreshSummary : function() {
        ...
        if (!this.view.summaryWrap) {
            this.view.summaryWrap = Ext.DomHelper[this.position=='bottom' ? 'insertAfter' : 'insertBefore'](this.view.scroller, {
                ...
                style   : 'overflow:hidden;' + (Ext.isIE ? 'width:100%;overflow:hidden;height:' + ((Ext.getScrollBarWidth ? Ext.getScrollBarWidth() : this.scrollBarWidth) + 4/* 18 = row-expander height */) + 'px;' : ''),
                tag     : 'div',
