Kdn.form.DateRangeField = Ext.extend(Ext.form.Field, {
    defaultAutoCreate: {
        tag: 'input',
        type: 'hidden'
    ...
    initComponent: function() {
        Kdn.form.DateRangeField.superclass.initComponent.call(this);
        ...
        Ext.apply(this, {
            type: new Kdn.form.ComboBox({
                ...
                store: new Ext.data.ArrayStore({
                    id: 0,
                    fields: ['id', 'name'],
                    data: [[1, 'Год'], [2, 'Квартал'], [3, 'Месяц'], [4, 'Диапазон дат']]
                }),
                width: 110,
                value: 4,
                listeners: {
    ...
    onRender: function(ct, position) {
        ...
        Kdn.form.DateRangeField.superclass.onRender.call(this, ct, position);
    ...
    setValue:function(value) {
        Kdn.form.DateRangeField.superclass.setValue.call(this, value);
...
Ext.reg('daterangefield', Kdn.form.DateRangeField);