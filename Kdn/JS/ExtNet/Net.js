...
Ext.override(Ext.util.Observable,
{
    ...
    {
        var me = this,
            e, oe, filterOptRe = /^(?:scope|delay|buffer|single)$/,
            ce;
...
Ext.net.MultiCombo = Ext.extend(Ext.form.ComboBox, {
    ...
    initSelection: function (selection) {
        ...
        if (this.store.getCount() > 0) {
            ...
            this.store.on("load", setInitValues.createDelegate(this, [selection]), this, {
                single: true
            });
        }
    },
    initComponent: function () {
        this.editable = false;
        if (!this.tpl) {
            this.tpl = '<tpl for="."><div class="x-combo-list-item {[this.getItemClass()]}">' + '<img src="' + Ext.BLANK_IMAGE_URL + '" class="{[this.getImgClass(values)]}" />' + '<div class="x-mcombo-text">{' + this.displayField + '}</div></div></tpl>';
...
setRawValue:function(value,text){
	Ext.net.DropDownField.superclass.setRawValue.call(this,text);
	this.getUnderlyingValueField().setValue(value);
	if(!this.isExpanded()){
		this.syncValue(value,text);
	}
...
getUnderlyingValueField:function(){
	...
	this.underlyingValueField=new Ext.form.Hidden({
		...
		this.on("beforedestroy",function(){if(this.rendered){this.destroy();}},
			this.underlyingValueField);
	}
	return this.underlyingValueField;
},

getText:function(){return Ext.net.DropDownField.superclass.getValue.call(this);},
...
reset:function(){if(this.isTextMode()){this.setValue(this.originalText,false);}else{this.setValue(this.originalValue,this.originalText,false);}
